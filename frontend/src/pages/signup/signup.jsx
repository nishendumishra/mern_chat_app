      ...
      bg-opacity-0'>
        ...
        <form onSubmit={handleSubmit}>
            <div>
                ...
                <input type='text' placeholder='Nishendu Mishra' className='w-full input input-bordered h-10'
...
//                       <span className='text-base label-text'>Full Name</span>
//                   </label>
//                   <input type='text' placeholder='Nidhi' className='w-full input input-bordered h-10'/>
//               </div>
